...
try:
    ...
    parsed_data = {
        ...
        "InsideTemperature": round(payload[34], 2),
        "InsideHumidity": round(payload[35], 2),
        "OutsideTemperature": round(payload[36], 2),
        "OutsideHumidity": round(payload[37], 2),
        ...
        "batLevel": round(battery_level, 2),
        "CRC": payload[42],
